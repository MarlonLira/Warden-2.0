...
<script src="<%=Help.FormatUrl("/assets/js/core/bootstrap.min")%>"></script>
...
<script src="<%=Help.FormatUrl("/assets/js/plugins/bootstrap-notify")%>"></script>
...
<script>
  ...
  <script src="https://cdn.trackjs.com/agent/v3/latest/t")%>"></script>
  <script>
    window.TrackJS &&
      TrackJS.install({
