...
<!--  Data Table   -->
<script src="<%=Help.FormatUrl("/assets/js/datatable/jquery.dataTables.min.js")%>"></script>
<script src="<%=Help.FormatUrl("/assets/js/datatable/jquery.tablesorter.js")%>"></script>
