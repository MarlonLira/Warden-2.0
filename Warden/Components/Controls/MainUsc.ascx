<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MainUsc.ascx.cs" Inherits="Warden.Components.Controls.MainUsc" %>
...
<asp:Panel ID="pnl_control" runat="server">
      <div class="content">
        ...
        <div class="row">
          <usc:ChartLineUsc runat="server" ID="chartLineControl" Text="Sends" />
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
